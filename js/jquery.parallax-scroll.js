            ...
            for (c = 0; c < d; c++) {
                ...
                A = Math.max(A, h), A = Math.min(A, v), w && (null == s.data("sens") && s.data("sens", "back"), A > h && ("back" == s.data("sens") ? (_ = 1, s.data("sens", "go")) : _++), A < v && ("go" == s.data("sens") ? (_ = 1, s.data("sens", "back")) : _++), a && (_ = g), s.data("current-time", _)), this._properties.map($.proxy(function(a) {
                    ...
                    if (null != e) {
                        ...
                        var n = (A - h) / (v - h) * (e - t) + t,
                            o = l + (n - l) / y;
                        if (w && _ > 0 && _ <= g) { var c = t; "back" == s.data("sens") && (c = e, e = -e, w = x, g = f), o = $.easing[w](null, _, c, e, g) }(o = Math.ceil(o * this.round) / this.round) == l && n == e && (o = e), r[a] || (r[a] = 0), r[a] += o, l != r[a] && (s.data("_" + a, r[a]), i = !0)
                    }
                }, this))
            }
            if (i) {
